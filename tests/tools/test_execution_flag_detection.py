...
@pytest.mark.parametrize(
    ...
    [
        ...
        # F1 counterexamples from Gauge: alias to eval, open() for writing, nested import rebind
        ...
        "python3 -BWc'import sys; print(sys.stdin.read())' -c 'import sys; exec(sys.stdin.read())'",
