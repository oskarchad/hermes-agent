...
def _terminate_reclaimed_worker(
    ...
    *,
    ...
    if started_at == UNVERIFIED_WORKER_FINGERPRINT:
        ...
        info["cleanup_verified"] = info["terminated"] and not info["scope_expected"]
        return info
...
def detect_stale_running(
    ...
    *,
    ...
    rows = conn.execute(
        "SELECT t.id, t.worker_pid, t.worker_started_at, t.last_heartbeat_at, t.claim_lock, t.current_run_id, "
        "       COALESCE(r.started_at, t.started_at) AS active_started_at "
        "FROM tasks t "
        "LEFT JOIN task_runs r ON r.id = t.current_run_id "
...
def check_respawn_guard(
    ...
    continuation; re-spawning risks a duplicate PR — unless a handoff event
