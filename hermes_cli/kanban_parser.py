...
_SPECS = [
    ...
    _cmd("promote", [
        _TASK_ID,
        _arg("reason", nargs="*", help="Audit-trail reason; required to continue an already-ready task"),
        _bulk_ids("promote"),
        _arg("--force", action="store_true", help="Override parents for todo/blocked promotion, never for ready continuation"),
    ...
    ], help="Promote todo/blocked tasks or explicitly continue idle ready tasks"),
    _cmd("archive", [
