    ...
    *,
    ...
    def run():
        ...
        try:
            ...
            if not captain_turn and terminal_receipt_committed:
            ...
            if not terminal_committed:
                ...
                try:
                    ...
                    _emit_terminal_turn_error(
                        ...
                        retire_marker=(
                            not captain_turn and terminal_receipt_committed
                        ),
                    )
            ...
            # hosted-room turns retain their marker until the receipt commits.
            if not captain_turn and terminal_receipt_committed:
                _retire_turn_marker(session, marker_key)
                with session["history_lock"]:
